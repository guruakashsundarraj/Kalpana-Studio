          ...
          <div className="faq-grid">
            <div className="card">
              <div className="card-content">
                ...
                <p>We recommend booking 2-4 weeks in advance for regular sessions and 
            ...
            <div className="card">
              <div className="card-content">
                ...
                <p>All sessions include professional photography, basic editing, 
            ...
            <div className="card">
              <div className="card-content">
                ...
                <p>Yes! We offer on-location photography throughout the region. 
            ...
            <div className="card">
              <div className="card-content">
                ...
                <p>Most sessions are delivered within 1-2 weeks. Wedding galleries 
