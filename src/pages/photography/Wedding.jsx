...
const plans = [
  {
    title: "Classic",
    price: "₹15,000",
    features: ["Full-day shoot", "100 edited images", "Digital album"],
  },
  {
    title: "Premium",
    price: "₹25,000",
    features: ["Pre-wedding + wedding", "150 images", "Video highlights"],
  },
  {
    title: "Luxury",
    price: "₹40,000",
    features: ["Drone, album", "All RAW files", "2 photographers"],
  },
];
...
const Wedding = () => {
  return (
    <div className="portfolio-detail-page">
      <section className="portfolio-header bg-img">
