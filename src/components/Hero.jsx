  ...
  return (
    <div className="hero-header">
      <div className="hero-column">
        ...
        <div className="hero-actions">
          <button className="hero-button1">
            <span className="body">{props.action1}</span>
          </button>
          <button className="hero-button2">
            <span className="body">{props.action2}</span>
          </button>
        </div>
      </div>
      ...
      <div className="hero-content2">
        {/* First row of images */}
        <div className="hero-row-container1">
          <div className="animated-group-container-horizontal">
            <div className="animated-group-horizontal">
        ...
        <div className="hero-row-container2">
          <div className="animated-group-container-horizontal">
            <div className="animated-group-horizontal-reverse">
      ...
      {/* Keyframes moved into external CSS (Hero.css) to avoid duplicate/contradictory definitions */}
    </div>
  );
};
